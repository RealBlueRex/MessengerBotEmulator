package org.hui1601.emulator.platform.ui.dialog;
...
public class IDialogBoxView extends StackPane implements Initializable {
    ...
    final Stage stage;
    IDialogBoxType type;
    IDialogBoxType.DOCUMENT document;
    Region content;
    String title;
    @FXML
    private BorderPane brpRootPane;
    @FXML
    private ImageView imvDialogIcon;
    @FXML
    private HBox hbxButtonBox;
    @FXML
    private IButton btnOK;
    @FXML
    private IButton btnNO;

    // Document Type
    public IDialogBoxView(IDialogBoxType.DOCUMENT document) {
