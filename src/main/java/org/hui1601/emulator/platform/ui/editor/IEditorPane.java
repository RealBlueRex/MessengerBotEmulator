...
import org.hui1601.emulator.platform.application.views.actions.CloseTabAction;
import org.hui1601.emulator.platform.application.views.actions.DeleteEditorPaneAction;
import org.hui1601.emulator.platform.application.views.actions.SelectEditorTabAction;
import org.hui1601.emulator.platform.application.views.actions.SplitEditorPaneAction;
    ...
    public IEditorPane(IEditorTab... tabs) {
        ...
        setOnKeyPressed(event ->
        {
            ...
            if (event.isAltDown()) {
                switch (event.getCode()) {
                    case LEFT:
                        SelectEditorTabAction.update(this, Side.LEFT);
                        break;
                    case RIGHT:
                        SelectEditorTabAction.update(this, Side.RIGHT);
                        break;
                }
            }
        });
